...
$sql = mysql_query("SELECT * FROM {$tablePrefix}_viewongoingbg WHERE memberid='{$_SESSION['memberid']}' AND gid='{$_SESSION['gid']}' AND urturn=1", $conn) or q_die(__file__, __line__, $conn);
